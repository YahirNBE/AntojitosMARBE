...
<body>
            ...
            <tbody id="resultados">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <td>
                            <div class="buttons">
                                <button class="btn-2 btn-editar" data-editar="' . $row["id_pedido"] . '">
                                ...
                                <button class="btn-3 btn-eliminar" data-eliminar="' . $row["id_pedido"] . '">
    ...
    <div id="modalEditar" class="Ventana">
        <div class="Ventana-content">
            ...
            <form method="POST" action="editarPedido.php">
                <input type="number" id="editar_id_pedido" name="id_pedido" hidden>
                <label>Estado:</label>
                <select name="estado_pedido" id="editar_estado_pedido" required>
    ...
    <script>
        ...
        document.getElementById("btn-excel").addEventListener("click", function () {
            ...
            let nombreArchivo = `Pedidos_${dia}-${mes}-${anio}.xls`;
    ...
    <script>
        ...
        document.addEventListener("click", function (e) {
            if (e.target.closest(".btn-eliminar")) {
                ...
                let idPedido = boton.getAttribute("data-eliminar");
    ...
    <script>
        ...
        document.addEventListener("click", function (e) {
            if (e.target.closest(".btn-editar")) {
                ...
                let idPedido = boton.getAttribute("data-editar");

                // Pedir datos al servidor
                fetch("obtenerPedidoEditar.php", {
                    method: "POST",
                    headers: { "Content-Type": "application/x-www-form-urlencoded" },
                    body: "idPedido=" + encodeURIComponent(idPedido)
                })
                    ...
                    .then(data => {
                        if (!data.error) {
                            ...
                            document.getElementById("editar_estado_pedido").value = data.estado_pedido;
                            document.getElementById("editar_id_pedido").value = data.id_pedido;
